          ...
          {isLoading ? (
            ...
            <div className="rounded-md border">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-left p-3 font-medium text-sm">Consultant</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Client</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">End client</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Start date</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Bill rate</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Pay rate</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Load%</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Total cost</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Margin</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Hours</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Comm%</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Total comm</TableHead>
                    <TableHead className="text-left p-3 font-medium text-sm">Cycle</TableHead>
                ...
                <TableBody>
                  {filteredData.map((record) => (
                    <TableRow key={record.id} className="hover:bg-gray-50">
                      <TableCell className="p-3 text-sm font-medium">{record.consultant_name}</TableCell>
                      <TableCell className="p-3 text-sm">{record.client}</TableCell>
                      <TableCell className="p-3 text-sm">{record.end_client || '-'}</TableCell>
                      <TableCell className="p-3 text-sm">{new Date(record.start_date).toLocaleDateString()}</TableCell>
                      <TableCell className="p-3 text-sm">{formatCurrency(record.bill_rate)}</TableCell>
                      <TableCell className="p-3 text-sm">{formatCurrency(record.pay_rate)}</TableCell>
                      <TableCell className="p-3 text-sm">{record.load_percent}%</TableCell>
                      <TableCell className="p-3 text-sm">{formatCurrency(record.totalCost)}</TableCell>
                      ...
                      <TableCell className="p-3 text-sm">{record.hours}</TableCell>
                      <TableCell className="p-3 text-sm">{record.commissionPercent}%</TableCell>
                      <TableCell className="p-3 text-sm font-medium">{formatCurrency(record.totalCommission)}</TableCell>
                      <TableCell className="p-3 text-sm">
