-- =========================================================
-- ATTENDEDGE PRODUCTION SYNC ARCHITECTURE
-- Proper Supabase Pattern: auth.users → employees → profiles
-- =========================================================
...
-- =========================================================
-- 8. CLEANUP OLD CONFLICTING OBJECTS
-- =========================================================

-- Remove unnecessary employee_profiles table if it exists
DROP TABLE IF EXISTS employee_profiles CASCADE;

-- Remove old bidirectional triggers
...
--       │
--       ▼
-- profiles   ← UI / APPLICATION DATA
--       │
--       ▼
-- performance_reports, attendance, leave_requests

-- Features:
-- ✓ Proper Supabase auth.users → employees → profiles flow
-- ✓ Safe auth.users existence check before profiles sync
-- ✓ Single source of truth: employees table
-- ✓ Comprehensive master view for frontend queries
-- ✓ No foreign key constraint violations
-- ✓ No duplicate tables or data
-- ✓ Production-ready with proper security
-- ✓ Clean monitoring and health checks

-- Usage:
-- Frontend should query employee_master_view for all employee data
-- Use employee_sync_health to monitor synchronization status
-- All HR operations should update employees table (master)
