...
- Organization Structure loads one company-scoped employee/team dataset for read-only hierarchy navigation. Super Admin changes use a minimal guarded RPC and audit row, rather than rewriting the hierarchy or fetching per employee.